...
POLICIES: list[PolicyNode] = [
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00004555",
        age_min     = 65,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00004556",
        age_min     = 18,
        income_max  = IR.MIDDLE_LOW,
        required_situations = [LS.DISABILITY],   # 장애 상황 필수
        required_docs = [
    ...
    PolicyNode(
        ...
        source      = "고용노동부",
        apply_url   = "https://www.work.go.kr/empInfo/neisWorkerService/neisWorkerServiceView.do",
        age_min     = 15,
        age_max     = 34,
        income_max  = IR.MIDDLE_LOW,
    ...
    PolicyNode(
        ...
        source      = "고용노동부",
        apply_url   = "https://www.work.go.kr/senior/info/seniorJobRecommInfo.do",
        age_min     = 40,
        required_situations = [LS.JOB],
        required_work       = [WS.JOB_SEEKING, WS.UNEMPLOYED, WS.OTHER],
        required_docs = [DocumentType.ID_COPY],
    ...
    PolicyNode(
        ...
        source      = "건강보험공단",
        apply_url   = "https://www.nhis.or.kr/nhis/policy/wbhace03800m01.do",
        age_min     = 65,
    ...
    PolicyNode(
        ...
        source      = "서울시",
        apply_url   = "https://youth.seoul.go.kr/site/main/content/monthlyrent",
        age_min     = 19,
        age_max     = 39,
        income_max  = IR.MIDDLE_LOW,
        regions     = ["서울특별시"],
    ...
    PolicyNode(
        ...
        source      = "경기도",
        apply_url   = "https://basicincome.gg.go.kr",
        age_min     = 24,
        age_max     = 24,
        regions     = ["경기도"],
        required_docs = [DocumentType.ID_COPY],
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00013233",
        age_max     = 7,
        required_situations = [LS.LIVING_COST, LS.EDUCATION],
        required_family     = [FS.WITH_CHILDREN, FS.SINGLE_PARENT],
        required_docs = [
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00018613",
        age_max     = 1,
        required_situations = [LS.LIVING_COST, LS.EDUCATION],
        required_family     = [FS.WITH_CHILDREN, FS.SINGLE_PARENT],
        required_docs = [
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00018614",
        age_max     = 0,
        required_situations = [LS.LIVING_COST],
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00004561",
        age_max     = 5,
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.mogef.go.kr/mp/pcd/mp_pcd_s001d.do?mid=plc503",
    ...
    PolicyNode(
        ...
        source      = "고용노동부·지자체",
        apply_url   = "https://www.moel.go.kr/info/medicSupport/index.do",
        required_situations = [LS.MEDICAL],
        required_docs = [DocumentType.ID_COPY],
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.mogef.go.kr/mp/pcd/mp_pcd_s001d.do?mid=plc508",
        age_max     = 12,
        required_situations = [LS.EDUCATION],
        required_family     = [FS.WITH_CHILDREN],
        required_docs = [
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.mogef.go.kr/sp/fam/sp_fam_s007.do",
        gender      = GS.FEMALE,
    ...
    PolicyNode(
        ...
        source      = "과학기술정보통신부",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00013214",
        income_max  = IR.LOW,
        required_situations = [LS.LIVING_COST],
        required_docs = [DocumentType.ID_COPY],
    ...
    PolicyNode(
        ...
        source      = "농림축산식품부",
        apply_url   = "https://www.mafra.go.kr/sites/mafra/sub/page.do?m=1030202010000",
    ...
    PolicyNode(
        ...
        source      = "보건복지부",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00021311",
        age_min     = 19,
        age_max     = 34,
        income_max  = IR.MIDDLE_LOW,
    ...
    PolicyNode(
        ...
        source      = "서울시",
        apply_url   = "https://youth.seoul.go.kr/site/main/welfare/welfareDetail?welfare_id=13",
        age_min     = 18,
        age_max     = 34,
        income_max  = IR.MIDDLE_LOW,
        regions     = ["서울특별시"],
    ...
    PolicyNode(
        ...
        source      = "국토교통부",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00018636",
        age_min     = 19,
        age_max     = 30,
        income_max  = IR.LOW,
        required_situations = [LS.HOUSING, LS.LIVING_COST],
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00021059",
        age_min     = 18,
    ...
    PolicyNode(
        ...
        source      = "보건복지부",
        apply_url   = "https://www.seoulmentalhealth.kr",
        income_max  = IR.MIDDLE_LOW,

...
POLICIES: list[PolicyNode] = [
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.mogef.go.kr/wm/wmc/wm_wmc_s001.do",
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.mogef.go.kr/wm/wml/wm_wml_s001.do",
        age_max     = 12,
        required_situations = [LS.EDUCATION],
        required_family     = [FS.WITH_CHILDREN],
        required_docs = [
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.mogef.go.kr/sp/fam/sp_fam_s003.do",
        gender      = GS.FEMALE,

...
POLICIES: list[PolicyNode] = [
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=%EB%8B%A4%EB%AC%B8%ED%99%94%EA%B0%80%EC%A1%B1%EC%A7%80%EC%9B%90%EC%84%BC%ED%84%B0",
    ...
    PolicyNode(
        ...
        source      = "여성가족부",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=%EB%8B%A4%EB%AC%B8%ED%99%94%EC%95%84%EB%8F%99%EC%96%B8%EC%96%B4%EB%B0%9C%EB%8B%AC",
        age_max     = 12,
        required_situations = [LS.EDUCATION],
        required_family     = [FS.WITH_CHILDREN],
        required_docs = [

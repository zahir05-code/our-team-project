...
POLICIES: list[PolicyNode] = [
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=국민기초생활보장",
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=긴급복지지원",
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=의료급여",
        income_max  = IR.LOW,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=주거급여",
        income_max  = IR.LOW,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=기초연금",
        age_min     = 65,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=장애인연금",
        age_min     = 18,
        income_max  = IR.MIDDLE_LOW,
        required_situations = [LS.DISABILITY],   # 장애 상황 필수
        required_docs = [
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=한부모가족지원",
        income_max  = IR.MIDDLE_LOW,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=노인일자리및사회활동지원",
        age_min     = 60,
        required_situations = [LS.JOB, LS.LIVING_COST],
    ...
    PolicyNode(
        ...
        source      = "건강보험공단",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=노인장기요양보험",
        age_min     = 65,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=아동수당",
        age_max     = 7,
        required_situations = [LS.LIVING_COST, LS.EDUCATION],
        required_family     = [FS.WITH_CHILDREN, FS.SINGLE_PARENT],
        required_docs = [
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=가정양육수당",
        age_max     = 5,
    ...
    PolicyNode(
        ...
        source      = "산업통상자원부",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=에너지바우처",
        income_max  = IR.LOW,
        required_situations = [LS.LIVING_COST],
        required_docs = [
            DocumentType.ID_COPY,
    ...
    PolicyNode(
        ...
        source      = "문화체육관광부",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=문화누리카드",
        income_max  = IR.LOW,
        required_situations = [LS.LIVING_COST],
        required_docs = [DocumentType.ID_COPY],
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=발달재활서비스",
        age_max     = 18,
        income_max  = IR.MIDDLE,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=가사간병방문지원서비스",
        income_max  = IR.MIDDLE_LOW,
    ...
    PolicyNode(
        ...
        source      = "복지로",
        apply_url   = "https://www.bokjiro.go.kr/ssis-tbu/search/search.do?query=자활급여",
        income_max  = IR.LOW,
        required_situations = [LS.JOB, LS.LIVING_COST],

...
GENDER_PATTERNS: dict[GenderStatus, list[str]] = {
    GenderStatus.FEMALE: [
        ...
        "여성가족", "성평등",
        # 임신·출산·영아 표현
        "임신 중", "임신했", "산후", "출산 후", "출산했",
        "아기 엄마", "아기 낳", "신생아 엄마", "모유",
    ],
    GenderStatus.MALE: [
        "남성", "남자", "아빠", "남편", "아버지", "아들",
        "남성분", "남자분", "가장", "군필",
...
SITUATION_PATTERNS: dict[LifeSituation, list[str]] = {
    ...
    LifeSituation.LIVING_COST: [
        ...
        "결식", "끼니", "생활이 어",
        # 구어체·감정 표현
        "한 푼도", "밥도 못", "끼니를 못", "빈털터리",
        "굶고", "굶어", "먹을 게 없", "밥이 없", "쌀이 없",
        "생계가 막막", "먹고 살기가", "생활이 막막",
        # 채무·부채 (나이 무관)
        "빚", "채무", "부채", "대출", "카드빚", "빚이",
        "신용불량", "파산", "채권", "연체",
        # 연금·노후 소득 부족
    ...
    LifeSituation.MEDICAL: [
        ...
        "번아웃", "공황", "PTSD", "트라우마",
        # 구어체·감정 표현
        "병원비가", "진료비", "치료비가", "약이 너무", "의료비가",
        "아이가 아파", "아이가 아프", "애가 아파", "몸이 너무",
        "쓰러져서", "쓰러졌", "응급실", "수술비가",
    ],
    ...
    LifeSituation.JOB: [
        ...
        "청년 취업", "첫 직장", "신입",
        # 구어체·일상 표현
        "일이 없", "일이 없어", "취직이 안", "취업이 안",
        "놀고 있", "일을 못 찾", "일 못 구", "직장이 없",
        "취직이 잘 안", "취직이 힘", "취업이 힘",
    ],
    ...
    LifeSituation.CARE: [
        ...
        "데이케어", "주간보호",
        # 영아·신생아 돌봄
        "갓난아기", "신생아", "영아", "아기 돌봄", "아기 돌봐",
        "산후도우미", "육아 도움", "육아 지원", "아이 봐줄",
    ],
    ...
    LifeSituation.CRISIS: [
        ...
        "가장이", "혼자 벌", "갑자기 혼자",
        # 구어체·가족 위기 표현
        "남편이 쓰러", "아내가 쓰러", "부모님이 쓰러",
        "하루아침에", "갑자기 입원", "갑자기 돌아가",
        "병원비가 없", "치료비가 없", "병원비를 못",
        "갑자기 직장을", "갑자기 해고", "갑자기 폐업",
    ],
